...
const skills = {
  Frontend: ["React.js", "React Native", "TypeScript", "JavaScript", "Tailwind CSS", "HTML/CSS"],
  Backend: ["Node.js", "Express.js", "Spring Boot", "REST APIs", "JWT Authentication"],
  Databases: ["MongoDB", "PostgreSQL", "MySQL"],
  Languages: ["JavaScript", "Python", "Java", "C++"],
  Tools: ["Git/GitHub", "Postman", "VS Code", "API Debugging"],
};
...
const skillDescriptions = {
  ...
  Tools: "Using the right tooling to debug, test, and ship features confidently.",
};
          ...
          {Object.entries(skills)
            ...
            .map(([category, items], index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="w-full max-w-sm rounded-2xl border border-white/10 bg-slate-900/80 p-6 text-left backdrop-blur-sm md:max-w-md"
              >
                <div className="mb-4">
                  <h3 className="text-sm font-semibold uppercase tracking-wide text-slate-100">
                    {category}
